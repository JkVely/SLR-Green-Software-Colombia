...
\textbf{Scopus:} \texttt{TITLE-ABS-KEY(("green cloud" OR "green computing" OR "sustainable cloud" OR "green software engineering" OR "green devops") AND (Colombia OR "Latin America")) AND PUBYEAR > 2010}. Notas: frases "" aproximadas, \{\} exactas, precedencia OR>AND, comodines * ?. Base $\ge$3.
\textbf{IEEE Xplore:} expansi\'on triple por t\'ermino \texttt{"Document Title":"..." OR "Abstract":"..." OR "Index Terms":"..."} + \texttt{AND ("All Metadata":Colombia OR "All Metadata":"Latin America")}; a\~no v\'ia faceta \texttt{\&ranges=2011\_2026\_Year}; l\'imite $\sim$15 t\'erminos/consulta.
\textbf{Google Scholar:} cadena corta \texttt{"green cloud" OR "green computing" OR "green software" Colombia}; cobertura plena \texttt{("green cloud" OR "green computing" OR "sustainable cloud" OR "green software engineering" OR "green devops") (Colombia OR "Latin America")}; AND impl\'icito, OR en may\'usculas; a\~no v\'ia rango as\_ylo=2011, as\_yhi=2026; reproducibilidad limitada.
\textbf{ACM DL:} \texttt{(Title:(...) OR Abstract:(...) OR Keyword:(...)) AND AllField:(Colombia OR "Latin America")} con los 5 t\'erminos; a\~no \texttt{\&AfterYear=2011\&BeforeYear=2026}; booleanos en may\'usculas, comod\'in *; alcance DL (expand=dl). Nota honesta: en ACM el geofiltro no devolvi\'o estudios con afiliaci\'on colombiana.
\textbf{Tabla de equivalencias:} TITLE-ABS-KEY $\approx$ Document Title/Abstract/Index Terms (IEEE), Title/Abstract/Keyword (ACM); comillas "" en todas; comod\'in *; filtro a\~no por PUBYEAR/faceta/rango.
...
Tabla de 8 criterios C1--C8 adaptada de Kitchenham con puntuaci\'on 0/0.5/1 desde frontmatter: pregunta clara, dise\~no apropiado, validez de evidencia, completitud, adecuaci\'on tipo fuente, contexto geogr\'afico, coherencia metodol\'ogica, actualidad. Bandas: Alta 7--8, Media 4--6, Baja 0--3. Permite reproducir puntuaci\'on sin re-lectura completa.
