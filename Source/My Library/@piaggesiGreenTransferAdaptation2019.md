...
## Notas clave
- Único documento de nivel de políticas de la colección que menciona directamente a Colombia: propuesta de transferencia de Tecnologías Verdes (Green ICT) desde Corea del Sur hacia industrias colombianas voluntarias.
- Marco de referencia coreano: Ley Básica de Crecimiento Verde Bajo en Carbono (2009), con meta de reducir emisiones de gases de efecto invernadero en 30 por ciento respecto al escenario business-as-usual hacia 2020.
- Mecanismo propuesto: cooperación Sur-Sur mediante KOICA (agencia coreana de desarrollo con representación en Colombia) y el Ministerio de Ambiente y Desarrollo Sostenible como contraparte nacional.
- Citable para demostrar que los avances green vinculados a Colombia provienen de transferencia tecnológica internacional, no de una política nacional propia; contraste directo con el liderazgo regulatorio de Corea o Europa.
- Señal relevante: 0 citas reportadas, indicio de baja apropiación académica del tema en la región.
- Uso sugerido: discusión (políticas) y análisis de brechas (dependencia de cooperación externa vs. agenda propia).
